...
setuptools.setup(
    ...
    description="Python wrapper for ncollide",
    url="https://github.com/tmigimatsu/ncollide-cpp",
    license="MIT",
    packages=["ncollide"],
    classifiers=[
    ...
    # install_requires=["ctrlutils"],
    ext_modules=[CMakeExtension("ncollide")],
    cmdclass={
