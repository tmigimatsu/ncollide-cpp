...
#[no_mangle]
extern fn ncollide2d_query_contains_point(shape: Option<&nc::shape::ShapeHandle<f64>>,
...
#[no_mangle]
extern fn ncollide2d_query_distance_to_point(shape: Option<&nc::shape::ShapeHandle<f64>>,
                                             m: Option<&math::CIsometry>,
...
#[no_mangle]
extern fn ncollide2d_query_project_point(shape: Option<&nc::shape::ShapeHandle<f64>>,
                                         m: Option<&math::CIsometry>,
                                         pt: Option<&[f64; nc::math::DIM]>,
                                         solid: bool,
...
#[no_mangle]
extern fn ncollide2d_query_ray_new(ptr_origin: Option<&[f64; nc::math::DIM]>,
                                   ptr_dir: Option<&[f64; nc::math::DIM]>) -> *mut nc::query::Ray<f64> {
    ray::ray_new(ptr_origin, ptr_dir)
}

#[no_mangle]
unsafe extern fn ncollide2d_query_ray_delete(ptr: *mut nc::query::Ray<f64>) {
    Box::from_raw(ptr);
}
...
#[no_mangle]
extern fn ncollide2d_query_closest_points(m1: Option<&math::CIsometry>,
...
#[no_mangle]
extern fn ncollide2d_query_contact(m1: Option<&math::CIsometry>,
                                   g1: Option<&nc::shape::ShapeHandle<f64>>,
                                   m2: Option<&math::CIsometry>,
                                   g2: Option<&nc::shape::ShapeHandle<f64>>,
                                   prediction: f64,
...
#[no_mangle]
extern fn ncollide2d_query_distance(m1: Option<&math::CIsometry>,
                                    g1: Option<&nc::shape::ShapeHandle<f64>>,
                                    m2: Option<&math::CIsometry>,
...
#[no_mangle]
extern fn ncollide2d_query_proximity(m1: Option<&math::CIsometry>,
                                     g1: Option<&nc::shape::ShapeHandle<f64>>,
                                     m2: Option<&math::CIsometry>,
                                     g2: Option<&nc::shape::ShapeHandle<f64>>,
...
#[no_mangle]
extern fn ncollide2d_query_time_of_impact(m1: Option<&math::CIsometry>,
